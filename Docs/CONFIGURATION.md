...
# Linux/Mac
cp backend/src/main/java/com/fsdm/pfe/delix/util/Constants.java.example backend/src/main/java/com/fsdm/pfe/delix/util/Constants.java
```
...
# Linux/Mac
cp backend/src/main/resources/firebase/delix-ma-firebase.json.example backend/src/main/resources/firebase/delix-ma-firebase.json
```
